...
static_assert(command_line_options::detail::is_positional_v<positional<"foo", "bar">>);
static_assert(command_line_options::detail::is_positional_v<multiple<positional<"foo", "bar">>>);
...
static_assert(std::is_same_v<
    command_line_options::detail::concat<utils::list<int, double>, utils::list<char, short>>,
